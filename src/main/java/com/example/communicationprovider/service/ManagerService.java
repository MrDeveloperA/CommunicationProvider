...
public class ManagerService implements UserDetailsService {
    ...
    public ApiResponse registerMangaer(RegisterDto registerDto) {
        ...
        manager.setRoles(Collections.singleton(roleRepository.findByRoleName(RoleNames.ROLE_HR_MANAGER)));
